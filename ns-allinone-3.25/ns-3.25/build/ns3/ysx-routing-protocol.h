...
#ifndef YSX_AGENT_IMPL_H
#define YSX_AGENT_IMPL_H

#include "ysxroute-header.h"
#include "ns3/test.h"
#include "ysx-state.h"
#include "ysx-repositories.h"
...
private:
  ...
  ysxroute::MessageList m_queuedMessages;
   ...
   */
  void ForwardDefault (ysxroute::MessageHeader olsrMessage,
   ...
   */
  void QueueMessage (const ysxroute::MessageHeader &message, Time delay);
   ...
   */
  void ProcessHello (const ysxroute::MessageHeader &msg,
   ...
   *
   */
  void ProcessTc (const ysxroute::MessageHeader &msg,
                  const Ipv4Address &senderIface);
   ...
   * \param senderIface the address of the interface where the message was sent from.
   */
  void ProcessMid (const ysxroute::MessageHeader &msg,
                   const Ipv4Address &senderIface);
   ...
   *
   */
  void ProcessHna (const ysxroute::MessageHeader &msg,
                   const Ipv4Address &senderIface);
   ...
   */
  void LinkSensing (const ysxroute::MessageHeader &msg,
                    const ysxroute::MessageHeader::Hello &hello,
                    const Ipv4Address &receiverIface,
                    const Ipv4Address &senderIface);
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateNeighborSet (const ysxroute::MessageHeader &msg,
                            const ysxroute::MessageHeader::Hello &hello);
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateTwoHopNeighborSet (const ysxroute::MessageHeader &msg,
                                  const ysxroute::MessageHeader::Hello &hello);
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateMprSelectorSet (const ysxroute::MessageHeader &msg,
                               const ysxroute::MessageHeader::Hello &hello);
