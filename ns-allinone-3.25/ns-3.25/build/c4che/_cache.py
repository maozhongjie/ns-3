...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-O0', '-ggdb', '-g3', '-Wall', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['wireless', 'tcp', 'socket', 'stats', 'naming', 'matrix-topology', 'udp', 'tutorial', 'realtime', 'routing', 'udp-client-server', 'error-model', 'traffic-control', 'energy', 'ipv6']
...
VALGRIND_FOUND = True
VERSION = '3.25'
WITH_PYBINDGEN = '/home/mzj/workspace/NS3/ns-allinone-3.25/pybindgen-0.17.0.post49+ng0e4e3bc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/mzj/workspace/NS3/ns-allinone-3.25/ns-3.25/build/ns3/config-store-config.h', '/home/mzj/workspace/NS3/ns-allinone-3.25/ns-3.25/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
