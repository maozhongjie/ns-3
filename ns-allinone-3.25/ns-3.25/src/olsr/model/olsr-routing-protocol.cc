  ...
  if (canRunOlsr)
    {
      //HelloTimerExpire ();
      //TcTimerExpire ();
      Simulator::Schedule(Seconds(stage5),&RoutingProtocol::HelloTimerExpire,this);
      Simulator::Schedule(Seconds(stage5),&RoutingProtocol::TcTimerExpire,this);
      NS_LOG_DEBUG ("OLSR Initialize on node " << m_mainAddress << " started");
...
{
  NS_LOG_FUNCTION (this);
//  NS_LOG_UNCOND(this->m_mainAddress<<"send hello"<<Simulator::Now());
